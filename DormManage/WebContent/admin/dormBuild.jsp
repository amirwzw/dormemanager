			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='dormBuildManage?action=manage&floor=${dormBuildManage.floor }'">管理</button>&nbsp;
						    <button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='dormBuild?action=manager&dormBuildId=${dormBuild.dormBuildId }'">管理员</button>&nbsp;
