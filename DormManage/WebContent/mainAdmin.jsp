...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 110px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 20px;padding-left: 30px;"; ><img src="logo.jpg"></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="dormManager?action=list"><i class="icon-chevron-right"></i>宿舍管理员管理(功能未补全)</a></li>
					<li><a href="student?action=list"><i class="icon-chevron-right"></i>学生管理</a></li>
					<li><a href="dormBuild?action=list"><i class="icon-chevron-right"></i>宿舍楼管理(功能未补全)</a></li>
					<li><a href="no.1 dormBuildManage?action=list"><i class="icon-chevron-right"></i>南区一号楼管理(功能未补全)</a></li>
					<li><a href="record?action=list"><i class="icon-chevron-right"></i>缺勤记录(功能未补全)</a></li>
