...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">沈师大宿舍管理系统</font></h2>
		...
		<p align="center" style="padding-top: 15px;">版权所有  2018  <a href="http://acm.edibc.top" target="_blank"> 博创工作室 EDI </a></p>
      </form>
</div>
</body>
</html>